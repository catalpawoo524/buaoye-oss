...
public class BuaoyeOssConfiguration {
    ...
    @Bean
    public BayOssClientManager bayOssClientManager(@Autowired BayOssClientProperty bayOssClientProperty) {
    ...
    @Bean
    public BayOssCacheTask bayOssCacheTask(@Autowired BayOssCacheProperty bayOssCacheProperty) {
